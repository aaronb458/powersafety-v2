...
export function ContactForm() {
  ...
  const config = formsConfig.forms.contact;
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      trackFormSubmission("contact", { referral: data.referral });
      setStatus("success");
      setData(initial);
    } catch {
      setStatus("error");
  ...
  return (
    ...
    >
      ...
      <FormField label="Best Time to Reach You" name="bestTime" type="select" options={config.fields.bestTimeOptions as unknown as string[]} value={data.bestTime} onChange={onChange} />
      <FormField label="Message" name="message" type="textarea" required value={data.message} onChange={onChange} placeholder="Tell us about your project or question..." />
